...
# To reach the root project and go to "api/win64-dev-avx512", go up 2 levels
OUTPUT_DIR = File.expand_path(File.join(__dir__, '..', '..', 'api'))
OUTPUT_FILE = File.join(OUTPUT_DIR, 'win64-dev-avx512')
...
# Fetch the download URL for RobRich win64 avx512 archive from the JSON
download_url = current_data.dig('github', 'robrich_win64_archive_avx512') || "https://github.com/RobRich999/Chromium_Clang"

# ==========================================
# 3. EXTRACT DATA VIA REGEX
# ==========================================
# Example URL: https://github.com/RobRich999/Chromium_Clang/releases/download/v151.0.7874.0-r1641382-win64-avx512/chrome.zip
...
if download_url =~ /v([\d\.]+)-r(\d+)/
  ...
  tag_version = "v#{version}-r#{revision}-win64-avx512"
end
...
# ==========================================
# 5. WRITE THE OUTPUT TO api/win64-dev-avx512
# ==========================================
