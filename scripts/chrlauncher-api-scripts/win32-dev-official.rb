...
OUTPUT_FILE = File.join(OUTPUT_DIR, 'win32-dev-official')
...
download_url = current_data.dig('google', 'Win_archive')

if download_url.nil? || download_url.empty?
  abort "Error: google.Win_archive not found!"
end
...
# ==========================================
# Example:
# https://storage.googleapis.com/chromium-browser-snapshots/Win/1650031/chrome-win.zip

revision = download_url[/Win\/(\d+)\//, 1] || "unknown"

repository_url =
  "https://storage.googleapis.com/chromium-browser-snapshots/index.html?prefix=Win/#{revision}/"
...
# 8. OUTPUT
# ==========================================
puts "=== CHROMIUM WIN32 API GENERATOR ==="
