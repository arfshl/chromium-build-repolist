...
# Target output: api/win64-stable-ungoogled
OUTPUT_DIR = File.expand_path(File.join(__dir__, '..', '..', 'api'))
OUTPUT_FILE = File.join(OUTPUT_DIR, 'win64-stable-ungoogled')
...
download_url = current_data.dig('github', 'eloston_win64_archive')
...
# ==========================================
# 5. WRITE THE OUTPUT TO api/win64-stable-ungoogled
# ==========================================
File.write(OUTPUT_FILE, api_string)

puts "=== UNGOOGLED WIN64 API GENERATOR ==="
